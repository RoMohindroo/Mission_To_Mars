...
# --------------------------------------------------------------------------
# Initialize connection to MongoDb; default port 27017
...
def render_index():
    ...
    try:
        ...
        # Distribute data from collection
        ...
        # Missing collection; clear fields
        news_title = ""
        paragraph_text_1 =""
        paragraph_text_2 = ""
        featured_image_url = ""
...
# --------------------------------------------------------------------------
# Initialize scrape route & insert results into  mars_data_DB in MongoDB
# --------------------------------------------------------------------------
@app.route('/scrape')
